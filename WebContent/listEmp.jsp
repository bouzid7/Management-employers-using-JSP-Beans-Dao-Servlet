...
<div>
<button type="button" class="btn btn-primary">Liste de tous les employées</button>
...
<tr>
      ...
      <td>
<a href="Update_servlet?id=${e.getId()}" style="background-color:greenyellow;" class="btn btn-default border">update <i class="fa fa-edit"></i></a>
